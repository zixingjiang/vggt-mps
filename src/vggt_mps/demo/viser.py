"""
VGGT Viser Demo — faithful mirror of vendor/vggt/demo_viser.py with MPS support.
"""
...
from vggt_mps.config import MODEL_DIR, get_precision, get_mps_memory_mb, get_mps_driver_memory_mb
...
def run(args):
    """Run the viser demo with parsed Namespace args."""
